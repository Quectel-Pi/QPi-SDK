...
enum rtw_mac_ax_null_type {
	RTW_MAC_AX_NULL_PKT = 0,
	RTW_MAC_AX_QNULL_PKT = 1,
};
...
struct rtw_hal_mac_apf_ctrl {
	u32 macid:16;
	u32 apf_en:8;
	u32 apf_prog_frag_num:8;
	u32 mac_pktid:8;
	u32 apf_pktid1:8;
	u32 apf_pktid2:8;
	u32 apf_pktid3:8;
	...
	u32 apf_ram_size:16;
	u32 apf_prog_size:16;
	u32 version[2];
	u32 hw_aes_iv:8;
	u32 rx_forward:8;
	u32 rsvd:16;
	u32 multicast_mask:16;
	u32 rsvd1:16;
	u32 rsvd2;
	u32 *ptr_apf_ram_buffer;
	u32 *ptr_status;
};
...
struct rtw_hal_mac_apf_ofld_report {
	u32 num;
	u32 len;
	u32 offset_len;
	u32 status;

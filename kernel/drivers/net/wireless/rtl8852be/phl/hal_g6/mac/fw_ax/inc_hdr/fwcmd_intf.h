...
#define FWCMD_H2C_APF_OFLD_CTRL_PTR_STATUS_SH 0
#define FWCMD_H2C_APF_OFLD_CTRL_PTR_STATUS_MSK 0xffffffff
...
#define FWCMD_C2H_STA_DIAG_SCAN_NUM_MACID_PAUSE_SLEEP_MISMATCH_MSK 0x3

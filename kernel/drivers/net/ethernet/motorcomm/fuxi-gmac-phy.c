...
void fxgmac_set_phy_link_ksettings(struct fxgmac_pdata *pdata)
{
    ...
    /* In this old architecture, the PHY reset will eventually be done in
     * phy_config or fxgmac_phy_force_mode.
     */
#ifdef FXGMAC_DOWNGRADE_DISABLED
    hw_ops->phy_downgrade_feature(pdata, 0);
#endif

#ifdef FXGMAC_PHY_SLEEP_ENABLED

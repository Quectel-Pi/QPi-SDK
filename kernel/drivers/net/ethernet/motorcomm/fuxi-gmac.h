...
enum fxgmac_led_force_state {
    FXGMAC_LED_FORCE_INACTIVE,
    FXGMAC_LED_FORCE_ACTIVE,
    FXGMAC_LED_FORCE_ON,
    FXGMAC_LED_FORCE_OFF
};
...
struct fxgmac_hw_ops {
    ...
    int (*reset)(struct fxgmac_pdata* pdata);
    ...
    void (*force_led_state)(struct fxgmac_pdata* pdata, u32 state);
    ...
    void (*phy_downgrade_feature)(struct fxgmac_pdata* pdata, u32 enable);
    void (*phy_downgrade_retry_limit)(struct fxgmac_pdata* pdata, u32 limit);
    void (*phy_fast_linkdown_feature)(struct fxgmac_pdata* pdata, u32 enable);
    void (*phy_mdix_status)(struct fxgmac_pdata* pdata, u32 *mdix_status, u32 *mdix_ctrl);
    void (*phy_set_mdix_ctrl)(struct fxgmac_pdata* pdata, u32 mdix_ctrl);
#endif

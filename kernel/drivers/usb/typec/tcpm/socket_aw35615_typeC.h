...
enum aw35615_typea_path {
	AW35615_TYPEA_PATH_SAFE = 0,
	AW35615_TYPEA_PATH_DEVICE_CC1,
	AW35615_TYPEA_PATH_DEVICE_CC2,
	AW35615_TYPEA_PATH_HOST_CC1,
	AW35615_TYPEA_PATH_HOST_CC2,
	AW35615_TYPEA_PATH_FLOAT,
};
...
struct aw35615_chip {
	...
	/* board glue for Type-A OTG mux control */
	struct gpio_desc *pupdctl1_gpiod; /* GPIO4_C4 */
	struct gpio_desc *pupdctl2_gpiod; /* GPIO4_C5 */
	struct gpio_desc *gpio2d7_gpiod;  /* GPIO2_D7 */

	bool factory_override;
	struct dentry *ft_override_dentry;
	struct dentry *ft_path_dentry;
	bool vbus_enabled_by_tcpm;
	bool usb0_host_path0_applied;

...
#ifndef _GOODIX_GT9XX_V282_H_
#define _GOODIX_GT9XX_V282_H_
...
struct goodix_ts_data {
	...
	bool force_update;
	bool init_done;
    bool use_irq;          // 是否使用中断模式
    bool irq_disabled;     // 中断是否被禁用
};
...
#define GTP_I2C_NAME		"goodix-v282-ts"
...
extern void gtp_reset_guitar_v282(struct i2c_client *client, s32 ms);
extern void gtp_int_sync_v282(struct goodix_ts_data *ts, s32 ms);
...
extern u16 show_len_v282;
extern u16 total_len_v282;
extern u8 gup_init_update_proc(struct goodix_ts_data *);
extern s32 gup_update_proc_v282(void *dir);
extern s32 gup_enter_update_mode_v282(struct i2c_client *client);
extern void gup_leave_update_mode_v282(struct i2c_client *client);

extern s32 init_wr_node(struct i2c_client *);
extern void uninit_wr_node(void);

/*********** For gt9xx_update Start *********/
extern struct i2c_client *i2c_connect_client_v282;
extern void gtp_reset_guitar_v282(struct i2c_client *client, s32 ms);
extern void gtp_int_output(struct goodix_ts_data *ts, int level);
extern s32 gtp_send_cfg_v282(struct i2c_client *client);
extern s32 gtp_get_fw_info(struct i2c_client *, struct goodix_fw_info *fw_info);
extern s32 gtp_i2c_read_dbl_check_v282(struct i2c_client *, u16, u8 *, int);
extern int gtp_i2c_read_v282(struct i2c_client *, u8 *, int);
extern int gtp_i2c_write_v282(struct i2c_client *, u8 *, int);

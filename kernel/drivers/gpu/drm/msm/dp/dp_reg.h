...
#define REG_DP_MST2_MST3_STATE_CTRL		(0x00000000)
...
#define REG_DP_MST2_MST3_CONFIGURATION_CTRL	(0x00000034)
...
#define REG_MST2_MST3_SOFTWARE_NVID		(0x00000044)
...
#define MMSS_DP_MST2_MST3_GENERIC0_0		(0x000000BC)
#define MMSS_DP_GENERIC0_1			(0x00000304)
#define MMSS_DP_MST2_MST3_GENERIC0_1		(0x000000C0)
#define MMSS_DP_GENERIC0_2			(0x00000308)
#define MMSS_DP_MST2_MST3_GENERIC0_2		(0x000000C4)
